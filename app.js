/* NEC26 Exam Simulator — Application Logic */

const ACCESS_CODE  = "NEC269000";
const EXAM_SECONDS = 14400;
const PASSING_PCT  = 70;
const STORAGE_KEY  = "nec26_exam_state_v1";
const SIM_Q_COUNT  = 1300;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const DOMAIN_LABELS = {"definitions_theory_calculations_and_plan_reading": "Definitions Theory Calculations and Plan Reading", "services": "Services", "feeders": "Feeders", "branch_circuit_calculations_and_conductors": "Branch Circuit Calculations and Conductors", "wiring_methods": "Wiring Methods", "equipment_and_devices": "Equipment and Devices", "motors_and_generators": "Motors and Generators", "control_devices": "Control Devices", "special_occupancies": "Special Occupancies", "renewable_energy_systems": "Renewable Energy Systems"};  // maps domain key -> human-readable label for display
